    ...
    "2. 야간 손저림과 엄지 근력 약화": {
        ...
        "differential_diagnosis": [
            ...
            },
            {
                ...
                "practical_tip": "감각신경전도 이상이 있으면 앞뼈사이신경증후군 가능성은 낮고 근위부 정중신경병증 또는 손목굴증후군을 먼저 고려하세요. 손목굴증후군은 원위부 정중신경병증에 포함됩니다."
            }
        ]
    },
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "뒤뼈사이신경은 노신경의 주로 깊은 운동가지(deep motor branch)이므로 감각저하가 뚜렷하지 않고 표재감각신경활동전위(SNAP)도 보통 정상입니다. 이 사례는 손등 감각저하와 감각신경활동전위 감소가 있어 보다 근위부의 노신경병증이 적절합니다.",
            ...
            },
            {
                ...
                "how_to_differentiate": "신경뿌리병증이면 말초 감각신경전도가 보존되는 경우가 많고, 목 척추주위근 이상이 동반될 수 있습니다. 이 사례는 감각신경활동전위가 감소하고 척추주위근이 정상이라 말초 노신경병증이 더 적절합니다.",
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "L5 신경뿌리병증이면 감각신경전도가 보존되는 경우가 많고, 허리 척추주위근과 중간볼기근(gluteus medius) 등 다른 L5 지배 근육의 이상이 동반됩니다. 이 사례는 감각신경활동전위 감소와 척추주위근 정상 소견이 있어 말초 종아리신경병증이 더 적절합니다.",
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "다중 신경뿌리병증이면 말초 감각신경전도는 비교적 보존될 수 있고, 허리 척추주위근 이상이 나타날 가능성이 있습니다. 이 사례는 감각신경활동전위가 감소하고 척추주위근이 정상이라 신경얼기병증이 더 적절합니다.",
...
def build_diff_dx_details(dx_name):
    detail_map = {
        "손목굴증후군 포함 정중신경 포착병증 (Median Entrapment Neuropathy)": "정중신경 관련 감각 및 운동 잠복기 지연이 중심이면 손목굴 부위 정중신경 포착병증 가능성이 높습니다. 감별 시에는 C6-C7 신경뿌리병증처럼 감각신경활동전위가 보존되는 패턴인지, 또는 근위부 정중신경병증처럼 전완부 정중신경 지배 근육까지 더 넓게 침범하는지 함께 봐야 합니다.",
        "정중신경병증 (Median Neuropathy)": "이상 소견이 정중신경 관련 항목에 모여 있으면 정중신경병증을 생각합니다. 감별 시에는 C8-T1 신경뿌리병증에서는 감각신경활동전위가 보존될 수 있고, 아래팔신경얼기병증에서는 정중신경 외 다른 신경 분포 이상이 함께 나타날 수 있다는 점을 비교하세요.",
        "자신경병증 (Ulnar Neuropathy)": "이상 소견이 자신경 관련 항목에 모여 있으면 자신경병증을 생각합니다. 감별 시에는 C8-T1 신경뿌리병증에서 감각신경활동전위가 보존될 수 있고, 아래팔신경얼기병증에서는 자신경 외 정중신경 분포 이상이 함께 나타날 수 있다는 점을 비교하세요.",
        "팔꿈치부 자신경병증 (Ulnar Neuropathy at Elbow)": "자신경 관련 검사 이상과 손 intrinsic muscle 이상이 함께 있으면 팔꿈치부 자신경병증 가능성이 높습니다. 감별 시에는 손목 수준 자신경병증인지, 또는 C8-T1 신경뿌리병증처럼 감각신경활동전위 보존 패턴인지 함께 확인해야 합니다.",
        "노신경병증 (Radial Neuropathy)": "이상 소견이 노신경 관련 항목에 모여 있고 손목 또는 손가락 폄 약화가 동반되면 노신경병증 가능성이 높습니다. 감별 시에는 C7 신경뿌리병증처럼 감각신경활동전위가 보존되는지, 뒤뼈사이신경병증처럼 감각 이상 없이 운동 이상만 두드러지는지 비교하세요.",
        "종아리신경병증 (Peroneal Neuropathy)": "이상 소견이 종아리신경 관련 항목에 모여 있고 발처짐이 동반되면 종아리신경병증 가능성이 높습니다. 감별 시에는 L5 신경뿌리병증처럼 감각신경활동전위가 보존되는지, 허리 척추주위근이나 중간볼기근 침범이 있는지 함께 봐야 합니다.",
        "정강신경병증 (Tibial Neuropathy)": "이상 소견이 정강신경 관련 항목에 모여 있으면 정강신경병증을 생각합니다. 감별 시에는 S1 신경뿌리병증처럼 H반사 지연 또는 소실과 척추주위근 이상이 동반되는지 확인하세요.",
        "목 신경뿌리병증 (Cervical Radiculopathy)": "감각신경전도 이상은 뚜렷하지 않은데 목 척추주위근과 관련 근육에서 비정상 자발전위가 보이면 목 신경뿌리병증 가능성이 높습니다. 말초신경병증과 감별할 때는 감각신경활동전위 보존 여부와 척추주위근 침범이 핵심입니다.",
        "허리 신경뿌리병증 (Lumbar Radiculopathy)": "감각신경전도 이상은 뚜렷하지 않은데 허리 척추주위근과 관련 다리 근육에서 비정상 자발전위가 보이면 허리 신경뿌리병증 가능성이 높습니다. 종아리신경병증과 감별할 때는 감각신경활동전위 보존 여부, 중간볼기근/척추주위근 침범 여부를 함께 봐야 합니다.",
        "팔신경얼기병증 (Brachial Plexopathy)": "여러 팔 신경에 걸친 이상이 있지만 목 척추주위근 이상이 뚜렷하지 않으면 팔신경얼기병증을 생각할 수 있습니다. 신경뿌리병증과 달리 감각신경활동전위 이상이 동반될 수 있고, 단일 말초신경병증보다 더 넓은 분포를 보입니다.",
        "허리엉치신경얼기병증 (Lumbosacral Plexopathy)": "여러 다리 신경에 걸친 이상이 있지만 허리 척추주위근 이상이 뚜렷하지 않으면 허리엉치신경얼기병증을 생각할 수 있습니다. 신경뿌리병증과 달리 감각신경활동전위 감소가 동반될 수 있고, 단일 말초신경병증보다 넓은 분포를 보입니다.",
