CASE_LIBRARY = {
    "목-팔 통증 증상과 팔 근력 약화": {
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사 (MMT)": [
                    "팔꿉관절 굽힘 (Elbow flexion): Fair (3/5) - 위팔두갈래근(Biceps brachii), 근피신경(Musculocutaneous), C5-C6",
                    "손목관절 폄 (Wrist extension): Fair (3/5) - 긴/짧은노쪽손목폄근(ECRL/B), 노신경(Radial), C6-C7"
                ],
                "반사 검사": [
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                ...
                "노신경 및 근피신경의 말단 운동신경전도도 정상이어서 말초 단일신경병증(mononeuropathy)의 가능성은 낮습니다."
            ],
            "emg_reason": [
            ...
            "integration": [
                "피부분절에 일치하는 증상, 맨손 근력검사(MMT) 약화 패턴, 감각신경전도 보존, 척추주위근 침범 소견을 종합할 때 C6 목 신경뿌리병증(C6 radiculopathy)으로 해석하는 것이 가장 적절합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "말초 노신경병증이라면 표재감각신경(SNAP) 진폭 감소나 전도 지연이 나타나야 하며, 척추주위근은 정상이어야 합니다. 본 사례는 감각신경전도(SNAP) 보존 및 척추주위근 침범이 있어 배제할 수 있습니다.",
                "practical_tip": "신경뿌리병증(radiculopathy)과 말초신경병증(peripheral neuropathy) 감별의 핵심은 '감각신경전도의 보존 여부'와 '척추주위근의 침범 여부'입니다."
            }
        ]
    },
    "야간 손저림과 엄지 근력 약화": {
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사 (MMT)": [
                    "엄지손가락 벌림 (Thumb abduction): Good (4/5) - 짧은엄지벌림근(APB), 정중신경(Median), C8-T1"
                ],
                "반사 검사": [
                    "상지 깊은힘줄반사(DTR): 정상 (2+) 대칭적 유지",
                    "특수 검사: 팔렌 검사(Phalen's test) 양성(positive sign), 손목 티넬 징후(Tinel's sign) 양성(positive sign)"
                ]
            }
        },
        "findings": {
        ...
        "teaching_diagnosis": {
            "summary": "손목굴증후군(Carpal Tunnel Syndrome)을 시사하는 전형적인 정중신경 포착병증(Median nerve entrapment)입니다.",
            "ncs_reason": [
                "정중신경 감각신경 및 운동신경 모두에서 잠복기 지연이 관찰되어 손목굴 부위의 말이집탈락성 변화(국소 전도 지연)를 의미합니다."
            ],
            "emg_reason": [
                "짧은엄지벌림근(APB)에서 비정상 자발전위가 출현한 것은 신경 포착이 심해져 축삭 손상(탈신경) 단계까지 진행되었음을 시사합니다."
            ],
            "integration": [
                "야간 통증, 정중신경 감각영역 저하, 맨손 근력검사(MMT)에서 엄지 벌림 약화, 정중신경 특이적 전도 지연을 종합하면 손목굴증후군이 명확합니다."
            ]
        },
        "differential_diagnosis": [
            {
    ...
    "위팔뼈 몸통 골절 후 손목처짐": {
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사 (MMT)": [
                    "손목 폄 (Wrist extension): Poor (2/5) - 손목폄근군(Wrist extensor carpi), 노신경(Radial nerve), C6-C7",
                    "손가락 폄 (Finger extension): Poor (2/5) - 손가락폄근군(Finger extensor), 노신경, C7-C8",
                    "팔꿉관절 폄 (Elbow extension): Normal (5/5) - 위팔세갈래근(Tricpes), 노신경, C6-C8"
                ],
                "반사 검사": [
                    "위팔세갈래근힘줄반사 (Triceps reflex): 정상 (2+)"
                ]
            }
        },
        "findings": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "노신경의 감각신경(SNAP) 진폭 감소는 병변이 뒤뿌리신경절(DRG) 원위부인 말초 노신경 자체에 있음을 의미합니다.",
                "노신경의 운동신경(CMAP) 진폭 감소는 운동 축삭의 심각한 손상 또는 손상 부위의 전도 차단을 의미합니다."
            ],
            "emg_reason": [
                "침근전도에서 손목폄근과 집게폄근에 탈신경 소견이 있으나 목 척추주위근은 정상이므로, C7 신경뿌리병증(C7 radiculopathy)을 배제할 수 있습니다."
            ],
            "integration": [
                "골절 병력, 맨손 근력검사(MMT)상 위팔세갈래근은 보존되나 손목/손가락 폄이 약화된 점(나선홈 이하 병변 시사), 말초 신경전도 이상 소견을 종합할 때 노신경병증(Radial Neuropathy)이 적절합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "뒤뼈사이신경(PIN)은 노신경(혼합 신경: 감각/운동)의 순수 운동신경 가지이므로 감각 소실이 없으며 표재감각신경(SNAP)이 정상으로 유지됩니다. 본 사례는 감각 저하와 감각신경전도(SNAP) 감소가 뚜렷하므로 더 근위부인 나선홈 부위의 노신경 본줄기 손상입니다. 노신경은 팔꿈치 근처에서 대체로 표재가지(감각)와 심부가지(운동)로 나뉘며, 심부가지는 이후 PIN으로 이어집니다. 손목 폄근 중 긴노쪽손목폄근(extensor carpi radialis longus)은 노신경 본 줄기지배, 짧은노쪽손목폄근(extensor carpi radialis)과 자쪽손목폄근(extensor carpi ulnaris)은 뒤뼈사이신경(PIN) 지배를 받습니다.",
    ...
    "4, 5번째 손가락 저림과 손가락 근력 약화": {
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사 (MMT)": [
                    "새끼손가락 벌림 (Little finger abduction): Fair (3/5) - 새끼벌림근(ADM), 자신경(Ulnar), C8-T1",
                    "손가락 벌림/모음 (Finger abduction/adduction): Fair (3/5) - 첫째등쪽뼈사이근(FDI), 자신경, C8-T1"
                ],
                "반사 검사": [
                    "팔의 깊은힘줄반사(DTR): 모두 정상 (2+)",
                    "특수 검사: 팔꿉관절 굽힘 검사(Elbow flexion test) 양성(positive sign), 팔꿈치 자측 티넬 징후(tinnel sign) 양성(positive sign)"
                ]
            }
        },
        "findings": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "자신경 감각 및 운동 신경전도에서 관찰되는 잠복기 지연은 전형적인 국소 포착에 의한 말이집탈락성(demyelinating) 변화입니다."
            ],
            "emg_reason": [
                "자신경 지배 손 자체기원근육(intrinsic muscles)인 새끼벌림근(ADM)과 첫째등쪽뼈사이근(FDI)에서 탈신경 소견이 확인되어 운동 축삭 손상이 동반되었음을 알 수 있습니다."
            ],
            "integration": [
                "특정 손가락 감각저하, 맨손 근력검사(MMT)에서 손의 자체기원근육(intrinsic muscle) 약화, 팔꿈치 스트레스 검사 양성(positive sign), 자신경 단독 전도 지연을 바탕으로 팔꿈치부 자신경병증으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "신경뿌리병증은 말초 감각신경(SNAP)이 정상으로 유지되며, 정중신경 지배근(abductor pollicis brevis)도 함께 침범되는 경우가 많습니다. 본 사례는 자신경 영역에 국한된 이상이 뚜렷합니다.",
    ...
    "허리-다리 통증과 발처짐": {
        "patient": {
            ...
            "side": "우",
            "symptoms": [
                "허리에서 우측 엉치, 종아리 가쪽, 발등으로 뻗치는 방사통(radiating pain)과 저림(numbness)",
            ...
            "physical_exam": {
                ...
                "맨손 근력검사 (MMT)": [
                    "발목 등굽힘 (Ankle dorsiflexion): Fair (3/5) - 앞정강근(TA), 깊은종아리신경(deep peroneal nerve), L4-L5",
                    "엄지발가락 폄 (Great toe extension): Poor (2/5) - 긴엄지폄근(EHL), 깊은종아리신경(deep peroneal nerve), L5",
                    "엉덩관절 벌림 (Hip abduction): Good (4/5) - 중간볼기근(Gluteus medius), 위볼기신경(superior gluteal nerve), L4-S1"
                ],
                "반사 검사": [
                    "무릎반사(Knee jerk): 정상 (2+)",
                    "아킬레스힘줄반사(Ankle jerk): 정상 (2+)"
                ]
            }
        },
        "findings": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                ...
                "허리 척추주위근 탈신경 소견은 병변이 척수신경 앞가지로 갈라지기 전인 신경뿌리(root) 부위임을 확증합니다."
            ],
            "integration": [
                "L5 방사통(radiating pain), 다중 신경 영역 약화(L5 공통 분절), 감각신경(SNAP) 보존, 척추주위근 침범을 통해 L5 신경뿌리병증(L5 radiculopathy)으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "종아리신경병증이라면 감각전도(SNAP)가 저하되고, 중간볼기근(Gluteus medius)이나 척추주위근은 정상이어야 합니다. 중간볼기근 맨손 근력검사(MMT) 시 약화 및 침근전도 이상 유무가 주요 감별 포인트입니다.",
                "practical_tip": "발처짐 환자 평가 시 엉덩관절 벌림(Hip abduction) 맨손 근력검사(MMT)를 반드시 확인하여 L5 신경뿌리(root) 손상 여부를 감별해야 합니다."
            }
        ]
    },
    "정강뼈 골절로 석고붕대 후 발처짐과 발등 감각저하": {
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사 (MMT)": [
                    "발목 등굽힘 (Ankle dorsiflexion): Poor (2/5) - 앞정강근(Tibialis anterior), 깊은종아리신경(Deep peroenal), L4-5",
                    "엄지발가락 폄 (Great toe extension): Trace (1/5) - 긴엄지폄근(EHL), 깊은종아리신경, L5",
                    "발목 가쪽번짐 (Ankle eversion): Poor (2/5) - 긴종아리근(PL), 얕은종아리신경(Superficial peroenal), L5-S1, L5 우세",
                    "발목 안쪽번짐 (Ankle inversion, L5 우세) 및 발바닥굽힘 (Plantarflexion, S1 우세): Normal (5/5) - 정강신경(Tibial) 보존"
                ],
                "반사 검사": [
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "침근전도에서 깊은종아리신경 지배근(Tibialis anterior)과 얕은종아리신경 지배근(Peroneus longus) 모두 탈신경 소견이 있어 분기 전인 온종아리신경 본줄기 병변임을 알 수 있습니다.",
                "허리 척추주위근이 정상이므로 신경뿌리병증을 배제합니다."
            ],
            "integration": [
                "석고붕대 압박 병력, 맨손 근력검사(MMT)상 종아리신경 지배 근육에 국한된 약화(발목 안쪽번짐 보존), 감각전도 이상을 종합하여 말초 종아리신경병증(Peroneal nerve neuropathy)으로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "맨손 근력검사(MMT)에서 발목 안쪽번짐(Inversion, L4-L5 정강신경 지배)이 보존된 점, 감각전도(SNAP)가 저하된 점, 척추주위근 침근전도가 정상인 점으로 신경뿌리병증을 배제합니다.",
    ...
    "골반 외상 후 다리 전반 근력 약화": {
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사 (MMT)": [
                    "엉덩관절 굽힘 (Hip flexion): Poor (2/5) - 엉덩허리근, 넓적다리신경(Femoral), 주로 L2-L3",
                    "무릎 폄 (Knee extension): Poor (2/5) - 넓적다리네갈래근, 넓적다리신경, L2-L4",
                    "발목 등굽힘 (Ankle dorsiflexion): Trace (1/5) - 앞정강근, 종아리신경(Peroneal), L4-L5",
                    "발목 발바닥굽힘 (Ankle plantarflexion): Poor (2/5) - 장딴지근, 정강신경(Tibial), S1-S2"
                ],
                "반사 검사": [
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                ...
                "종아리신경(궁둥신경 분지)과 넓적다리신경(허리신경얼기 분지) 운동신경전도(CMAP)가 모두 감소한 것은 상위 구조의 광범위한 손상을 의미합니다."
            ],
            "emg_reason": [
                "허리 및 엉치 분절의 여러 말초신경 지배 근육에 탈신경 소견이 광범위하게 관찰되나, 허리 척추주위근은 정상이어서 다발성 신경뿌리병증을 배제합니다."
            ],
            "integration": [
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "다발성 신경뿌리병증이라면 임상적 감각 소실이 심해도 말초 감각전도(SNAP)는 유지되는 경우가 많으며, 척추주위근 이상이 동반됩니다. 본 사례는 감각신경전도(SNAP) 저하와 척추주위근 보존으로 감별됩니다.",
    ...
    "양측 발끝 저림과 발가락 약화": {
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사 (MMT)": [
                    "양측 엄지발가락 폄 (Great toe extension): 깊은종아리신경(Peroenal), Good (4/5) - 경미한 원위부 근력 약화",
                    "양측 발목 등굽힘 (Ankle dorsiflexion): 깊은종아리신경, Normal (5/5)",
                    "근위부 근력(무릎/엉덩관절): 넓적다리신경(Femoral), Normal (5/5) 대칭적 보존"
                ],
                "반사 검사": [
                    "양측 아킬레스힘줄반사 소실 (0)",
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "만성 축삭 병변의 경우 발 자체기원근육(intrinsic) 등 가장 원위부 근육에서 비정상 자발전위가 보일 수 있으나, 진단은 신경전도검사의 대칭적 진폭 감소 패턴에 더 의존합니다."
            ],
            "integration": [
        ...
        "differential_diagnosis": [
            {
                ...
                "practical_tip": "신경전도검사(NCS) 결과지를 볼 때 '진폭(Amplitude)'과 '잠복기/속도(Latency/Velocity)' 중 어느 쪽 손상이 주된 패턴인지 먼저 분석하세요."
            }
        ]
    },
    "대칭성 팔다리 근력저하와 보행 저하": {
        ...
        "teaching_diagnosis": {
            "summary": "만성 염증성 말이집탈락성 다발신경병증(CIDP)을 의심할 수 있는 패턴입니다.",
            "ncs_reason": [
                "다수 감각/운동 신경에서 양측성 잠복기 지연이 나타나 광범위한 말이집탈락성 변화를 시사합니다.",
                "F파 지연 및 소실은 운동신경 뿌리를 포함한 근위부(Proximal)의 전도 이상을 강력히 뒷받침합니다."
            ],
            "emg_reason": [
                "말이집탈락성 질환의 초기/중기에는 축삭 손상이 경미하여 침근전도 탈신경 소견이 뚜렷하지 않을 수 있습니다. 후기 반사(F파) 확인이 중요합니다."
            ],
            "integration": [
                "근위부와 원위부를 모두 침범하는 맨손 근력검사(MMT) 대칭적 약화, 전신 무반사(Areflexia), 광범위 전도 지연 및 F파 이상을 통해 말이집탈락성 다발신경병증을 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "근육병증은 순수 운동 약화이므로 감각 검사는 정상이며, 반사(DTR)는 후기까지 보존되는 경우가 많습니다. 본 사례는 심한 감각전도 지연과 반사 소실이 있어 확실한 감별이 가능합니다.",
                "practical_tip": "맨손 근력검사(MMT) 양상만 보고 판단하지 말고, 반사 검사 소실 유무와 감각신경전도검사 이상 여부를 반드시 결합하여 해석하세요."
            }
        ]
    },
    "눈꺼풀 떨림과 눈 주위 불편감 지속": {
        ...
        "teaching_diagnosis": {
            "summary": "눈깜빡반사(Blink reflex)를 통해 삼차신경(affernet)-얼굴신경(efferent) 회로의 우측 들방향(Afferent) 편측 이상을 찾아내는 사례입니다.",
            "ncs_reason": [
            ...
            "integration": [
                "우측 삼차신경(V1) 감각 저하 병력과 우측 자극 시에만 전체 반사가 소실되는 패턴이 완벽히 일치하여, 삼차신경 들방향 경로(afferent pathway) 편측 손상으로 해석합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "날방향(efferent, 운동) 경로인 우측 얼굴신경 문제라면, '좌측 자극 시 우측 R2' 반응도 소실되어야 합니다. 본 사례는 좌측 자극 시 우측 R2가 정상이므로 얼굴신경(effernt)은 온전함을 입증합니다.",
                "practical_tip": "눈깜박반사(Blink reflex)에서 자극측 문제(Afferent)인지 반응측 문제(Efferent)인지 구분하는 훈련을 반복하세요."
            }
        ]
    },
    "뇌졸중 후 발목 발바닥굽힘근 경직 평가": {
        "patient": {
            ...
            "side": "우",
            "symptoms": [
                "뇌졸중 발병 후 편마비 상태이며, 최근 우측 발목 경직이 심해져 발처짐(foot drop) 및 발꿈치안쪽휜들린발(Equinovarus) 자세 악화",
            ...
            "physical_exam": {
                ...
                "맨손 근력검사 (MMT)": [
                    "우측 발목 등굽힘 (Ankle dorsiflexion): Poor (2/5) - 위운동신경세포(UMN) 병변 연관 수의적 조절력 저하",
                    "Modified Ashworth Scale (MAS): 발목 바닥굽힘근 수정된 애쉬워스 등급(MAS Grade) 3"
                ],
                "반사 검사": [
        ...
        "teaching_diagnosis": {
            ...
            "integration": [
                "뇌졸중 병력, 수정된 애쉬워스 등급(MAS Grade)에서 3등급의 심한 경직, 반사(DTR) 항진/간대경련 소견과 전기생리학적 H/M 비율 증가 소견이 완벽히 일치하여 중추성 척수반사 흥분성 증가 상태를 증명합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "practical_tip": "H 반사는 아래운동신경세포(말초) 손상 시에는 소실/지연되고, 위운동신경세포(중추) 손상 시에는 항진됨을 기억하세요."
            }
        ]
    },
    "급성 양측 다리 근력 약화": {
        ...
        "teaching_diagnosis": {
            "summary": "급성 염증성 다발신경병증(초기 기엥-바레 증후군, GBS)의 전형적인 초기 전기생리적 단서(F파 이상)를 보여줍니다.",
            "ncs_reason": [
            ...
            "integration": [
                "선행 감염력, 급성 상행성 이완성 마비, 전신 깊은힘줄반사 소실(Areflexia), F파 조기 이상을 종합하여 초기 기엥-바레 증후군(GBS)을 강하게 의심합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "practical_tip": "급성 마비 환자에서 반사(DTR)가 0(소실)이라면 신경 병변을 우선 고려하고, 전기생리적으로 'F파'를 먼저 확인하는 습관을 들이세요."
            }
        ]
    }
}
